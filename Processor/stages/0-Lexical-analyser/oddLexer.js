...
module.exports = new Lexer()
	...
	.rule("function-keyword", /fun(?:ction)?/)
	.rule("var-keyword", /const|var/)
	.rule("storage-modifier", /implements|extends|overt|delegate/)
	.rule("builtin", /event|Function|Array|Object|String|Boolean|Number|Math|Error|Class/)
